...
Python file to train and evaluate a MobileNetV3Large pretrained model with the SGD Optimizer on the Brain Tumor Dataset found on Kaggle.
...
df.to_csv('MobileNetV3Large_SGD.csv') 
...
model.save('MobileNetV3Large_SGD.keras')
