...
Python file to train and evaluate a VGG-16 pretrained model with Dropout layers on the Brain Tumor Dataset found on Kaggle.
...
model.save('VGG16_Dropout.keras')
