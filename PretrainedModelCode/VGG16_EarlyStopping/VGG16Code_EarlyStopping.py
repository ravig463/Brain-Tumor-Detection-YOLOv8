...
Python file to train and evaluate a VGG-16 pretrained model with Early Stopping on the Brain Tumor Dataset found on Kaggle.
...
for the glioma and meningioma tumor classes.
'''
        ...
        if file.endswith('.jpg'):
            ...
            if os.path.isfile(label_path):
                with open(label_path, 'r') as label_file:
                    ...
                    #Store the coordinates of this bounding box in the class_one_boxes list. Update the total number of labeled
...
#Instantiate EarlyStopping measure that stops training when the tracked metric (loss) hasn't improved after 5 successive epochs.
...
df.to_csv('VGG16_EarlyStopping_History.csv')
...
model.save('VGG16_EarlyStopping.keras')
