...
Python file to train and evaluate a VGG-16 pretrained model with the SGD Optimizer on the Brain Tumor Dataset found on Kaggle.
...
#Configure the model with the Mean Squared Error loss function, SGD optimizer, and various metrics.
...
model.save('VGG16Code_SGD.keras')
