...
Python file to train and evaluate a MobileNetV3Large pretrained model with Early Stopping on the Brain Tumor Dataset found on Kaggle.
...
df.to_csv('MobileNetV3Large_EarlyStopping.csv') 
...
model.save('MobileNetV3Large_EarlyStopping.keras')
